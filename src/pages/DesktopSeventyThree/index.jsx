              ...
              <div className="mt-[33px] flex flex-col gap-[33px] self-stretch pt-[5px]">
                ...
                <div className="flex flex-col gap-[30px]">
                  <div className="flex flex-col items-start gap-2.5">
                    ...
                    <div className="flex flex-col items-start gap-[13px]">
                      <div className="flex gap-3 sm:flex-col">
                        <Button className="flex h-[67px] min-w-[106px] items-center justify-center rounded-[22px] border border-solid border-gray-200_02 bg-white-A700_01 px-4 text-center font-inter text-[15px] tracking-[0.20px] text-gray-900">
                          09:00 AM
                        </Button>
                        <Button className="flex h-[67px] min-w-[105px] items-center justify-center rounded-[22px] border border-solid border-gray-200_02 bg-white-A700_01 px-4 text-center font-inter text-[15px] tracking-[0.20px] text-gray-900">
                          09:30 AM
                        </Button>
                        <Button className="flex h-[67px] min-w-[106px] items-center justify-center rounded-[22px] border border-solid border-gray-200_02 bg-white-A700_01 px-[17px] text-center font-inter text-[15px] tracking-[0.20px] text-gray-900">
                          10:00 AM
                        </Button>
                        <Button className="flex h-[67px] min-w-[105px] items-center justify-center rounded-[22px] border border-solid border-gray-200_02 bg-white-A700_01 px-[18px] text-center font-inter text-[15px] tracking-[0.20px] text-gray-900">
                          10:15 AM
                        </Button>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <Button className="flex h-[67px] min-w-[92px] items-center justify-center rounded-[22px] border border-solid border-gray-200_02 bg-green-800_01 px-3.5 text-center font-inter text-sm tracking-[0.20px] text-white-A700_01">
                          11:00 AM
                        </Button>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col items-start gap-3">
                    ...
                    <div className="flex flex-col items-start gap-[13px]">
                      <div className="flex gap-3 sm:flex-col">
                        <Button className="flex h-[67px] min-w-[104px] items-center justify-center rounded-[22px] border border-solid border-gray-200_02 bg-white-A700_01 px-[13px] text-center font-inter text-base tracking-[0.20px] text-gray-900">
                          04:00 PM
                        </Button>
                        <Button className="flex h-[67px] min-w-[104px] items-center justify-center rounded-[22px] border border-solid border-gray-200_02 bg-white-A700_01 px-3.5 text-center font-inter text-base tracking-[0.20px] text-gray-900">
                          04:15 PM
                        </Button>
                        <Button className="flex h-[67px] min-w-[103px] items-center justify-center rounded-[22px] border border-solid border-gray-200_02 bg-white-A700_01 px-3 text-center font-inter text-base tracking-[0.20px] text-gray-900">
                          04:30 PM
                        </Button>
                        <Button className="flex h-[67px] min-w-[104px] items-center justify-center rounded-[22px] border border-solid border-gray-200_02 bg-white-A700_01 px-[13px] text-center font-inter text-base tracking-[0.20px] text-gray-900">
                          04:45 PM
                      ...
                      <Button className="flex h-[62px] min-w-[104px] items-center justify-center rounded-[22px] border border-solid border-gray-200_02 bg-white-A700_01 px-[15px] text-center font-inter text-base tracking-[0.20px] text-gray-900">
                        05:15 PM
                      </Button>
                    </div>
                  </div>
