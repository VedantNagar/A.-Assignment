      ...
      <div className="w-full bg-white-A700_01 pb-[303px] md:pb-5">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="container-xs mt-[60px] flex flex-col items-end gap-[53px] px-[17px] md:p-5 sm:gap-[26px]">
            ...
            {/* doctor profile summary section */}
            <div className="mr-1 flex w-[96%] gap-10 md:mr-0 md:w-full md:flex-col">
              {[...Array(3)].map((d, index) => (
                <div
                  key={"list45" + index}
                ...
                >
                  <div className="mt-[3px] flex flex-col items-center gap-[15px]">
                    ...
                    <div className="flex flex-col items-start gap-[5px] self-stretch">
                      <Heading
                        size="3xl"
                        as="h1"
                        className="tracking-[-0.32px] !text-blue_gray-900_02"
                      >
                        Dr. Prerna Narang
                      </Heading>
                      <div className="flex flex-col items-center gap-3.5 self-stretch">
                        <div className="flex flex-col items-start gap-1.5">
                          <div className="flex items-start gap-[15px]">
                            ...
                            <Text
                              as="p"
                              className="tracking-[-0.16px] !text-gray-700_02"
                            >
                          ...
                          <div className="flex items-center gap-[7px]">
                            ...
                            <Heading
                              size="md"
                              as="h2"
                              className="self-end tracking-[-0.16px] !text-gray-700_02"
                            >
                          ...
                          <div className="flex items-start gap-3">
                            <Img
                              src="images/img_comment_1.png"
                              alt="image_three"
                              className="mt-0.5 h-[16px] object-cover"
                            />
                            <Text
                              as="p"
                              className="tracking-[-0.16px] !text-gray-700"
                            >
                        ...
                        <div className="flex justify-evenly gap-2 self-stretch">
                          <div className="flex flex-col items-center justify-center gap-1 rounded-[10px] border border-solid border-green-800_63 bg-orange-50 p-1">
                            <Heading
                              as="h3"
                              className="mt-[3px] tracking-[-0.14px] !text-gray-800_01"
                            >
                              Video Consultation
                            </Heading>
                            <Heading
                              as="h4"
                              className="!font-bold tracking-[-0.14px]"
                            >
                              ₹800
                            </Heading>
                          </div>
